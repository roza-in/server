...
} from './health-records.controller.js';
import {
 ...
 * @access Private
 */
router.get('/family-members', authMiddleware, listFamilyMembers);
 ...
 * @access Private
 */
router.get('/vitals/trends', authMiddleware, getVitalTrends);
 ...
 * @access Private
 */
router.get('/family-summary/:memberId', authMiddleware, getFamilyHealthSummary);
